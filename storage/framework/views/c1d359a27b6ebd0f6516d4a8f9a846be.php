    ...
    <main class="form-signin flex-fill">
        <form>
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingName" placeholder="Имя" required>
                <label for="floatingName">Имя</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingFName" placeholder="Фамилия" required>
                <label for="floatingFName">Фамилия</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingLName" placeholder="Отчество" required>
                <label for="floatingLName">Отчество</label>
            </div>
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control" id="floatingPassword" placeholder="Пароль" required>
            ...
            <button class="btn btn-primary w-100 py-2 mb-2" type="button" onclick="window.location.href='/BonusSystem/html/Home.html';">Зарегистрироваться</button>
            <button class="btn btn-primary w-100 py-2" type="button" onclick="window.location.href='/BonusSystem/html/Login.html';">Есть Аккаунт</button>
        </form>
    </main>
...
<?php /**PATH /home/tobecomeawind/Devs/OpenApi/resources/views/Registration.blade.php ENDPATH**/ ?>